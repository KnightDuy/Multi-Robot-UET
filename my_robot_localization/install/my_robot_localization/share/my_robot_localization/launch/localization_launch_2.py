...
def generate_launch_description():
    ...
    # AMCL remappings for robot2 - namespace the topics
    amcl_remappings = [
        ('/tf', 'tf'),
        ('/tf_static', 'tf_static'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(my_robot_dir, 'params', 'nav2_params_2.yaml'),
        ...
        actions=[
            ...
            Node(
                ...
                arguments=[
                    '--ros-args',
                    '--log-level', log_level,
                    '-p', 'qos_overrides.robot2/scan.subscription.reliability:=reliable',
                    '-p', 'qos_overrides.robot2/scan.subscription.durability:=volatile',
                ],
            ...
            Node(
                ...
                name='robot2_lifecycle_manager_localization',
                output='screen',
                arguments=['--ros-args', '--log-level', log_level],
