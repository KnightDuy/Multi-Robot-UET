...
def generate_launch_description():
    ...
    my_robot_dir = get_package_share_directory('my_robot_model')
    ...
    lifecycle_nodes = ['map_server', 'robot1_amcl']
    ...
    # AMCL remappings for robot1 - namespace the topics
    amcl_remappings = [
        ('/tf', 'tf'),
        ('/tf_static', 'tf_static'),
        ('initialpose', '/robot1/initialpose'),
        ('amcl_pose', '/robot1/amcl_pose'),
        ('particle_cloud', '/robot1/particle_cloud')
    ]
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(my_robot_dir, 'params', 'nav2_params.yaml'),
        ...
        actions=[
            ...
            Node(
                ...
                arguments=[
                    '--ros-args',
                    '--log-level', log_level,
                    '-p', 'qos_overrides.robot1/scan.subscription.reliability:=reliable',
                    '-p', 'qos_overrides.robot1/scan.subscription.durability:=volatile',
                ],
            ...
            Node(
                ...
                name='robot1_lifecycle_manager_localization',
                output='screen',
                arguments=['--ros-args', '--log-level', log_level],
